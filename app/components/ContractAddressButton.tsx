import { TldrawUiIcon, useToasts } from 'tldraw'
...
export function ContractAddressButton() {
    ...
    const handleClick = useCallback(() => {
        if (navigator.clipboard) {
            navigator.clipboard.writeText(appConfig.contractAddress)
            addToast({
                icon: 'duplicate',
    ...
    return (
        ...
        >
            {appConfig.contractAddress.slice(0, 4)}...
            <svg width="16" height="16" viewBox="0 0 389 389" fill="var(--color-text)" style={{ marginLeft: '2px' }}>
                <g transform="translate(0.000000,389.000000) scale(0.100000,-0.100000)">
                    ...
                    -73 -385 -347 -796 -797 -171 -187 -431 -470 -578 -630 -298 -322 -397 -446
